...
import com.ccbjb.common.mybatis.page.MysqlDialect;
...
public class BaseMybatisService<T> extends SqlSessionDaoSupport {

	private String NAMESPACE;
	final static  Class<? extends Object> SELF = BaseMybatisService.class;
	protected final Log logger = LogFactory.getLog(BaseMybatisService.class);
	/**默认的查询Sql id*/
	final static String DEFAULT_SQL_ID = "findAll";
	/**默认的查询Count sql id**/
	final static String DEFAULT_COUNT_SQL_ID = "findCount";
	public BaseMybatisService() {
		try {
